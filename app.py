...
import pandas as pd
from data import load_debt_data, total_annual_debt, total_annual_unemployment, filter_by_year, filter_by_years, filter_by_states, normalized_debt_per_capita, normalized_unemployment_per_capita
import json
import math
...
def update_line_charts(selected_states, selected_features, min_year, max_year, current_year, 
    ...
    for title, data in features.items():
        ...
        all_charts.append(dcc.Graph(figure=chart, className='dash-graph'))
